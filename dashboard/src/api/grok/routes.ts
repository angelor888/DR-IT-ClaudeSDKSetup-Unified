...
router.post('/chat/stream', authenticateToken, checkGrokEnabled, async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.id;
    const chatRequest: GrokChatRequest = req.body;
    ...
    log.info('Processing streaming chat request', { userId, conversationId: chatRequest.conversationId });
...
// Analysis endpoint
router.post('/analyze', authenticateToken, checkGrokEnabled, async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.id;
...
// Generation endpoint
router.post('/generate', authenticateToken, checkGrokEnabled, async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.id;
...
// Get conversations
router.get('/conversations', authenticateToken, checkGrokEnabled, async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.id;
...
router.get('/conversations/:id', authenticateToken, checkGrokEnabled, async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.id;
...
router.post('/conversations/:id/archive', authenticateToken, checkGrokEnabled, async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.id;
    const conversationId = req.params.id;
...
router.get('/conversations/search', authenticateToken, checkGrokEnabled, async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.id;
...
// Get capabilities
router.get('/capabilities', authenticateToken, checkGrokEnabled, async (req: Request, res: Response) => {
  try {
